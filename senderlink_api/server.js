...
// Railway usa un proxy — necesario para que rate-limit identifique IPs correctamente
...
// Usuarios: registro (POST /) con rate limit + token; GET y escrituras requieren token
app.use("/api/users", (req, res, next) => {
  // Registro: rate limit específico + token (para que createUser pueda validar req.uid)
  if (req.method === "POST" && req.path === "/") {
    return registrationLimiter(req, res, () => verifyToken(req, res, next));
  }
